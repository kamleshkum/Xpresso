...
public class InsuranceFiveLakh extends TestBase {
...
/*  int max = 99999999;
  ...
  @Test(priority = 0,testName = "5L with 1 Member")
public void withFiveLakhOneMember() throws SQLException {
  ciMainPOM.enterFirstPart("Individual","5L","1",InsuPeriod,InsuProduct,InsuType,nomineeName,"BROTHER");
...
//   dbClass = new DbClass();
  ...
  @Test(priority = 1, testName = " With 5L and 2 Members")
  public void withFiveLakhTwoMembers() throws SQLException {
    enterDetails("5L","2");
  }


  @Test(priority = 2, testName = " With 5L and 3 Members")
  public void withFiveLakhThreeMembers() throws SQLException {
    enterDetails("5L","3");
  }
  @Test(priority = 3, testName = " With 5L and 4 Members")
  public void withFiveLakhFourMembers() throws SQLException {
    enterDetails("5L","4");
  }
  @Test(priority = 4, testName = " With 5L and 5 Members")
  public void withFiveLakhFiveMembers() throws SQLException {
    enterDetails("5L","5");
  }
  @Test(priority = 5, testName = " With 5L and 6 Members")
  public void withFiveLakhSixMembers() throws SQLException {
    enterDetails("5L","6");
  }
