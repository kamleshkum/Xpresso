...
public class InsuranceOneLakh extends TestBase {
...
/*  int max = 99999999;
  ...
  @Test(priority = 0,testName = "1L with 1 Member")
public void withOneLakhOneMember() throws SQLException {
  ciMainPOM.enterFirstPart("Individual","1L","1",InsuPeriod,InsuProduct,InsuType,nomineeName,"BROTHER");
...
//   dbClass = new DbClass();
  ...
  @Test(priority = 1, testName = " With 1L and 2 Members")
  public void withOneLakhTwoMembers() throws SQLException {
    enterDetails("1L","2");
  }


  @Test(priority = 2, testName = " With 1L and 3 Members")
  public void withOneLakhThreeMembers() throws SQLException {
    enterDetails("1L","3");
  }
  @Test(priority = 3, testName = " With 1L and 4 Members")
  public void withOneLakhFourMembers() throws SQLException {
    enterDetails("1L","4");
  }
  @Test(priority = 4, testName = " With 1L and 5 Members")
  public void withOneLakhFiveMembers() throws SQLException {
    enterDetails("1L","5");
  }
  @Test(priority = 5, testName = " With 1L and 6 Members")
  public void withOneLakhSixMembers() throws SQLException {
    enterDetails("1L","6");
  }
